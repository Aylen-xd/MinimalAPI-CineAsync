...
{
    public Pelicula (byte idPelicula, byte idProduccion, string nombre, DateTime estreno, string descripcion, byte calificacion, TimeSpan duracion, byte restrincion, ulong recaudado)
    {
